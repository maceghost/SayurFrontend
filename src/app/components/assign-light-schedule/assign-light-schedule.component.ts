...
@Component({
  selector: 'app-assign-light-schedule',
  templateUrl: './assign-light-schedule.component.html',
  styleUrls: ['./assign-light-schedule.component.scss'],
})
export class AssignLightScheduleComponent implements OnInit {
