...
@Component({
  selector: 'app-mob-mycart',
  templateUrl: './mob-mycart.component.html',
  styleUrls: [  '../css/webflow.css','../css/normalize.css','../mob-portal/mob-portal.component.css'],
})
export class MobMycartComponent implements OnInit {
