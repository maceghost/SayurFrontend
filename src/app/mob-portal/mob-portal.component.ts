...
@Component({
  selector: 'app-mob-portal',
  templateUrl: './mob-portal.component.html',
  styleUrls: [  '../css/webflow.css','../css/normalize.css','./mob-portal.component.css'],
...
export class MobPortalComponent implements OnInit{
