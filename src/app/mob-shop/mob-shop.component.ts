...
@Component({
  selector: 'app-mob-shop',
  templateUrl: './mob-shop.component.html',
  styleUrls: [  '../css/webflow.css','../css/normalize.css','./mob-shop.component.css'],
...
export class MobShopComponent implements OnInit{
