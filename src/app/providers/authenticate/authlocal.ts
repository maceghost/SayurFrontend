...
export class AuthLocalProvider {
  ...
  processHomeControllers(data: any){
    ...
    //     if (i.status.sockets){
    //       if (i.status.sockets.space){
    //         // console.log('calling getLocalControllerStatus with i: '+JSON.stringify(i));
    //         this.getLocalControllerStatusAsync(i)
    //         .then(
    //             result => {
    //               this.handleControllerDetails(result, i)
    //
    //             },
    ...
    //         i.capname = i.name.toUpperCase();
    //         // console.log('adding sensor : ',i);
    //         // i.status.color = 'lightgreen';
    //         i.status.color = 'lightgrey';
    //         newsensors.push(i)
    //       }
    //       if (this.contains(i.name, 'outdoor temp') || this.contains(i.name, 'od temp') || this.contains(i.name, 'outside temp')) {
    //         if (i.status){
